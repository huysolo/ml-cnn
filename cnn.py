...
for epoch_no in range(0,epochs):
	...
	for index in range(0,60000):
		...
		cuda_conv_forward[(o1.shape[-1]),o1.shape[:-1]](data[index], f1, pro1)
		o1 = reLU(pro1)
		p1 = np.zeros([13,13,8])
		cuda_pool_forward[(p1.shape[-1]),p1.shape[:-1]](o1,p1)
		...
		f1_grad = np.zeros(f1.shape)
		cuda_conv_backward[(o1.shape[-1]),o1.shape[:-1]](data[index], f1, pro1_grad, dx, f1_grad)	
